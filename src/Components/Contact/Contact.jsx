    ...
    <div className="min-h-screen bg-[#F7F7F7] font-poppins flex flex-col items-center py-8 sm:py-12 px-4 sm:px-6 lg:px-10">
      <div className="max-w-7xl w-full">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h2 className="text-2xl sm:text-3xl font-semibold text-gray-800 mt-4">Contact Us</h2>
          <p className="text-base sm:text-lg text-gray-600 mt-2">We'd love to hear from you! Reach out with any questions or inquiries.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-lg shadow-xl border border-gray-200">
              ...
              <ul className="space-y-3 text-sm sm:text-base text-gray-600">
                <li>
                  ...
                  <a href="tel:+919879283930" className="text-orange-700">
                    +91 98792-83930
                  </a>
                </li>
                <li>
                  <span className="font-medium">Email:</span>{' '}
                  <a href="https://mailto:sujalpatel3350@gmail.com" className="text-orange-700 ">
            ...
            {/* Google Map Embed */}
            <div className="bg-white p-6 sm:p-8 rounded-lg shadow-xl border border-gray-200">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-4">Our Location</h3>
              <iframe
          ...
          {/* Contact Form */}
          <div className="bg-white p-6 sm:p-8 rounded-lg shadow-xl border border-gray-200">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-4">Send Us a Message</h3>
            <form id="contact-form" onSubmit={handleSubmit} className="flex flex-col space-y-4">
              ...
              <div>
                <label htmlFor="subject" className="text-sm sm:text-base font-medium text-gray-700">
                  Subject
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="message" className="text-sm sm:text-base font-medium text-gray-700">
                  Message
                </label>
                <textarea
                  id="message"
                  ...
                  rows="5"
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 border-b border-gray-500 focus:outline-none text-sm sm:text-base resize-none"
                  required
                ></textarea>
              </div>
              <button
        ...
        <div className="mt-8 sm:mt-12 flex flex-col items-center">
          <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-4">Connect With Us</h3>
